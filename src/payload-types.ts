...
export interface Config {
  ...
  jobs: {
    tasks: {
      buildSlicerContextTask: TaskBuildSlicerContextTask;
      sliceModelTask: TaskSliceModelTask;
      extractSlicerMetricsTask: TaskExtractSlicerMetricsTask;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'buildSlicerContextTask' | 'sliceModelTask' | 'extractSlicerMetricsTask';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  workflowSlug?: 'sliceGcode' | null;
  taskSlug?: ('inline' | 'buildSlicerContextTask' | 'sliceModelTask' | 'extractSlicerMetricsTask') | null;
  queue?: string | null;
...
export interface SiteSetting {
  id: number;
  /**
   * Used for public logo text, accessibility labels, and default metadata.
   */
  siteName?: string | null;
  /**
   * Used for copyright text. Falls back to the site name when empty.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskSliceModelTask".
 */
export interface TaskSliceModelTask {
  input: {
    gcodeId: string;
    filamentConfigPath?: string | null;
    processConfigPath?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskExtractSlicerMetricsTask".
 */
export interface TaskExtractSlicerMetricsTask {
  input: {
    gcodePath: string;
    gcodeId: string;
    index: number;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WorkflowSliceGcode".
 */
export interface WorkflowSliceGcode {
  input: {
    gcodeId: string;
  };
}
