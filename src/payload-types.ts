...
export interface Config {
  ...
  jobs: {
    tasks: {
      collectSliceContext: TaskCollectSliceContext;
      runSlicer: TaskRunSlicer;
      parseGcode: TaskParseGcode;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface Quote {
  ...
  items: {
    ...
    machine?: (number | null) | MachineConfig;
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'collectSliceContext' | 'runSlicer' | 'parseGcode';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
  ...
  taskSlug?: ('inline' | 'collectSliceContext' | 'runSlicer' | 'parseGcode') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskCollectSliceContext".
 */
export interface TaskCollectSliceContext {
  input: {
    gcodeId: string;
  };
  output: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskRunSlicer".
 */
export interface TaskRunSlicer {
  input: {
    gcodeId: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskParseGcode".
 */
